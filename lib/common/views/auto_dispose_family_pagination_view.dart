...
class AutoDisposeFamilyPaginationView<T> extends ConsumerStatefulWidget {
  const AutoDisposeFamilyPaginationView({
    super.key,
  ...
  final AutoDisposeFamilyNotifierProvider provider;
  ...
  @override
  ConsumerState<AutoDisposeFamilyPaginationView<T>> createState() =>
      _ConsumerPaginationViewState<T>();
}

class _ConsumerPaginationViewState<T>
    extends ConsumerState<AutoDisposeFamilyPaginationView<T>> {
